...
# Must be required before the apartment support file or the default tenant will be removed from truncation
...
RSpec.configure do |config|
  # Request/ResponseHelpers wrap, e.g., `get`, which is only available in
  ...
  config.include ColourizeHelper
